 ...
 */
class OllamaFunctions extends chat_models_1.BaseChatModel {
    static lc_name() {
    ...
    async _generate(messages, options, runManager) {
        ...
        const systemPromptTemplate = prompts_1.SystemMessagePromptTemplate.fromTemplate(this.toolSystemPromptTemplate);
