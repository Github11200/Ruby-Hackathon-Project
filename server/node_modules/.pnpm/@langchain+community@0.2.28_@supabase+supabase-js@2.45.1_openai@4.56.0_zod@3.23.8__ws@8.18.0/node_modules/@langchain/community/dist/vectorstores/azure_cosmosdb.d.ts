import { Document as MongoDBDocument, MongoClient, Filter } from "mongodb";
...
export declare class AzureCosmosDBVectorStore extends VectorStore {
     ...
     */
    createIndex(numLists?: number, dimensions?: number | undefined, similarity?: AzureCosmosDBSimilarityType): Promise<void>;
    /**
     ...
     */
    delete(params?: AzureCosmosDBDeleteParams | string[]): Promise<void>;
    /**
     ...
     */
    addVectors(vectors: number[][], documents: DocumentInterface[]): Promise<string[]>;
    /**
     ...
     * @returns A promise that resolves to the added documents IDs.
     */
    addDocuments(documents: DocumentInterface[]): Promise<string[]>;
    /**
